...
export const LENS_REGISTRY: LensDefinition[] = [
  ...
  { id: 'combined', label: 'Combined', icon: 'Columns2', description: 'Session evolution + playground in split view' },
  ...
  { id: 'playground', label: 'Playground', icon: 'Terminal', description: 'AI agent playgrounds & PTY terminals' },
