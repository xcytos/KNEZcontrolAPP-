                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="text-[10px] text-zinc-500 mt-1 flex items-center gap-2 flex-wrap">
                          <span className={`px-1.5 py-0.5 rounded border ${
                            statusInfo.connectionStatus === 'connected' ? 'bg-emerald-900/20 border-emerald-800 text-emerald-300' :
                            statusInfo.connectionStatus === 'connecting' ? 'bg-amber-900/20 border-amber-800 text-amber-300' :
                            statusInfo.connectionStatus === 'error' ? 'bg-red-900/20 border-red-800 text-red-300' :
